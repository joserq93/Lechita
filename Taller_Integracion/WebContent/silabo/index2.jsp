      ...
      <div class="modal-header">
        ...
        <br/><br/>
          ...
          <div class="form-group">
            ...
            <div id="agregarB">
            <input type="text" clas"form-control"  placeholder="Reseña bibliográfica" id="bibliografia_0" name="bibliografia_0" Required="Required"><br>
            </div>
            ...
            <input type="text" class="form-control" id="prom_final" name="prom_final" placeholder="Fórmula del Promedio Final" Required="Required">
           <br>
