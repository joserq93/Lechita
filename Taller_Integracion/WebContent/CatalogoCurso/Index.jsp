...
function ValidarCurso1(){
	tipo=document.getElementById("tipoC").selectedIndex;
	if(tipo==0){
		alert('Seleccione el tipo de curso');
		return false;
	}
	var codigo=document.getElementById("codigo").value;
	if(!(/^\d{4}$/.test(codigo))){
		alert('Faltan digitos al codigo');
		return false;
	}
}
...
<body class="page-body skin-red">
	...
	<div class="page-header">
      ...
      <div id="principal-app">
        ...
        <select id="lista" name="id_curso" class="form-control" onChange="validarCursos()" onClick="mostrarDatos()" Required="Required">
...
<!--------------------------------- Modal ---------------------------------------------------->
<form method="post" action="<%=request.getContextPath() %>/Curso" onSubmit="return ValidarCurso1();">
      ...
      <div class="modal-header">
        ...
        <br/><br/>
          ...
          <div class="form-group">
            	...
            	<input type="text" name="codigo" id="codigo" Required="Required" onKeyPress="return soloNumeros(event);" maxlength="4"/><br><br>
				Nombre del curso : <input type="text" name="nombre" Required="Required"/><br><br>
				Tipo del curso : 
				<select id="tipoC" name="tipo" required="required">
				<option value="">Seleccionar</option>
